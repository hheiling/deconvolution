...
save(genes_df, file = "Human_Materials/genes_simulated_w_diffExp_diffUsg.RData")
```
...
# mix_rep = 20
mix_rep = 2
rep_label = str_c("0",1:9,10:mix_rep)
...
for(p in 1:nrow(p_combos)){
  mix_labels[,p] = str_c("Mixture_ProbCombo_",p,"_Replicate_",rep_label,"_counts")
}
...
# for(p in 1:nrow(p_combos)){
#   fragLens_labels[,p] = str_c("Mixture_ProbCombo_",p,"_Replicate_", rep_label, "_fraglens")
# }

fragLens_out(total_reads = 10^7, mean = 300, SD = 50, lenMax = 600, 
             out_folder = "Human_Materials",
             file_names = "sim_fraglens.txt",
             seed = seeds[14])
```
